	        ...
	        <div class="page-wrapper">
	            ...
	            <div class="container-fluid">
	                ...
	                <div class="row">
						...
						<a class="btn-dd" href="https://shop2.fexpro.com/wp-admin/admin-ajax.php?action=report_purchase&export=1&{{url_params}}" target="_blank">Export All to XLSX</a>
						...
						<table class="table table-bordered" id="demo_table">
							<thead>
									...
									<th  style="vertical-align : middle;text-align:center;">Style sku <sage-filter-text list="filters.filter_sku" /></th>
		...
		<script>
			angular.module("app",['util-components']).controller("ctrl",function($scope,$http){
				...
				$scope.get_data=function(){
					...
					$http({
						url:"https://shop2.fexpro.com/wp-admin/admin-ajax.php?action=report_purchase",
						method:"POST",
						data:_params
