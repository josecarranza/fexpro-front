...
<script>
	...
	<body class="skin-default fixed-layout" ng-app="app" ng-controller="ctrl">
	    ...
	    <div id="main-wrapper">
	        ...
	        <div class="page-wrapper">
	            ...
	            <div class="container-fluid">
	                ...
	                <div class="row">
                       <div class="col-6">
					   		<a class="btn-dd" href="https://shop2.fexpro.com/wp-admin/admin-ajax.php?action=report_purchase_users&export=1&group_by={{group_by}}&{{url_params}}" target="_blank">Export All to XLSX</a>
						...
						<div class="exporting-it">
							...
							<thead>
									...
									<th  style="vertical-align : middle;text-align:center;" ng-repeat="seller in model.sellers">{{seller.label}}</th>
									...
									<th style="vertical-align : middle;text-align:center;">Status product</th>
									</tr>
								</thead>
								<tbody id="myTable">
		...
		<script>
			angular.module("app",['util-components']).controller("ctrl",function($scope,$http){
				$scope.model={};
				$scope.model.sellers=[];
				$scope.report=[];
				$scope.group_by="user";
				...
				$scope.get_data=function(){
					...
					_params={..._params,...$scope.sort,page:$scope.pag};
					if($scope.pag==1){
						$scope.report=[];
					}
					$scope.url_params=$.param( _params );
					$http({
						url:"https://shop2.fexpro.com/wp-admin/admin-ajax.php?action=report_purchase_users",
						method:"POST",
						data:_params,
