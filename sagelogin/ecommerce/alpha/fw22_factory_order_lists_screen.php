...
<html lang="en">
	...
	<head>
		...
		div#demo_table_wrapper.dt-bootstrap > .row:last-child > div {flex: 0 0 25%;max-width: 25%;}
			div#demo_table_wrapper table {display: block; overflow-x: scroll; margin: 30px; width: 95% !important;}
	...
	<body class="skin-default fixed-layout">
		...
		<script>
				...
				$(document).ready(function() {
					...
					var demo_table = $('#demo_table').dataTable({
						...
						columns: [
							...
							{ data: 'pdf_download' ,name: 'pdf_download'},
						],
						language:
						{
							search: "",
						...
						ajax: {
							...
							data:{action:"alpha_factory_order_list_datatables"},
							type: "POST",
					...
					$( document ).ajaxComplete(function() {
						...
						// Edit Order 
						$('#myTable tr .EditOrderNumber').bind('click', function (e) {
							e.preventDefault();
							...
							if (jQuery(this).hasClass("SaveOrderNumber")) {
								...
								form_data.append('action', 'alpha_save_ss22_factory_data_order_number');
						...
						$("#myTable tr .single-submit-it").bind('click', function (){
							...
							var getCurrentRowClass1 = $(this);
								...
								form_data.append('action', 'alpha_edit_ss22_factory_data');
						...
						$("#myTable tr .single-delete-it").bind('click', function() {
							var form_data = new FormData();		
							...
							form_data.append('getCurrentRowVariationID', getCurrentRowVariationID);	
							form_data.append('action', 'alpha_delete_fw22_single_factory_data');	
			...
			{	
				...
				form_data.append('hide_columns', 2 );
				form_data.append('action', 'alpha_export_factory_order_list_data');
				jQuery.ajax({
					type: "POST",
					url: "https://shop.fexpro.com/wp-admin/admin-ajax.php",
					contentType: false,
