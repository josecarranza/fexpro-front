    ...
    <body class="skin-default fixed-layout">
            ...
            <header class="topbar">
                <nav class="navbar top-navbar navbar-expand-md navbar-dark">
                    ...
                    <div class="navbar-header">
                        <a class="navbar-brand" href="https://shop2.fexpro.com/sagelogin/ecommerce/presale5/">
                            <!-- Logo icon --><b>
                        ...
                        <?php if (isset($_GET['purchased']) || isset($_GET['cat_purchased'])) { ?>
                            ...
                            <div class="exporting-it">
								...
								echo $terms_string; */
                                            ...
                                            $array_logo = array();
                                            if (!empty($logoApplication[0]->name)) {
                                                $array_logo[] = $logoApplication[0]->name;
                                            }
                                            if (!empty($logoApplication[1]->name)) {
                                                $array_logo[] = $logoApplication[1]->name;
                                            }
                                            if (!empty($logoApplication[2]->name)) {
                                                $array_logo[] = $logoApplication[2]->name;
                                            }
                                            if (!empty($logoApplication[3]->name)) {
                                                $array_logo[] = $logoApplication[3]->name;
                                            }
        ...
        <script>
            ...
            function fnExcelReport1() {
                ...
                form_data.append('getHeaderArray', JSON.stringify(myArray));
                form_data.append('action', 'alpha_export_cart_entries_all_data');
