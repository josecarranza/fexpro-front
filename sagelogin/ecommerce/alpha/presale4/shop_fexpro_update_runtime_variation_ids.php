...
if(is_admin()) return;
global $wpdb;
$deleteTableData = "DELETE FROM wp_presale4_run_time_v_id";
$wpdb->query( $deleteTableData );
$regenerateId = "ALTER TABLE wp_presale4_run_time_v_id AUTO_INCREMENT = 1";
$wpdb->query( $ddl );
...
foreach($final_result1 as $variation_id => $orderItemIds){
	...
	$wpdb->query("INSERT INTO wp_presale4_run_time_v_id (vid,item_id) VALUES ('$variation_id','$itemIdsArr')"  );		
}
