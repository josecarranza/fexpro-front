        ...
        <header class="topbar">
            <nav class="navbar top-navbar navbar-expand-md navbar-dark">
                ...
                <div class="navbar-header">
                    <a class="navbar-brand" href="https://shop.fexpro.com/sagelogin/ecommerce/alpha">
                        <!-- Logo icon --><b>
                ...
                <div class="row">
                	<table class="table table-bordered" id="demo_table">
                        <thead>
   						...
   						<tbody id="myTable">
   							<?php $get_all_factories = $wpdb->get_results( "SELECT * FROM alpha_wp_factory_list");  ?>
                            <?php foreach ($get_all_factories as $value) { ?>
                            	<tr>
	   								<td><?php echo $value->supplier_name; ?></td>
	   								<td><a href="<?php echo SITEURL; ?>/presale4/factory/<?php echo $value->supplier_slug ?>" target="_blank"><?php echo SITEURL .'/presale4/factory/'.$value->supplier_slug; ?></a></td>
	   							</tr>
                            <?php } ?>
