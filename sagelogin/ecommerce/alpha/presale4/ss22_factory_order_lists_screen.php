	...
	<body class="skin-default fixed-layout">
		...
		<script>
				...
				$(document).ready(function() {
					...
					var demo_table = $('#demo_table').dataTable({
						...
						ajax: {
							...
							data:{action:"alpha_presale4_factory_order_list_datatables"},
							type: "POST",
					...
					$( document ).ajaxComplete(function() {
						...
						$('#myTable tr .single-delete-it').bind('click', function (e) {
							var form_data = new FormData();		
							...
							form_data.append('action', 'delete_presale4_ss22_single_factory_data');	
						...
						$("#myTable tr .single-submit-it").bind('click', function (){
							...
							var getCurrentRowClass1 = $(this);
								...
								form_data.append('action', 'alpha_edit_presale4_ss22_factory_data');
			...
			{	
				...
				form_data.append('action', 'alpha_export_presale4_factory_order_list_data');
				jQuery.ajax({
					type: "POST",
					url: "https://shop.fexpro.com/wp-admin/admin-ajax.php",
					contentType: false,
