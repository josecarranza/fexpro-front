...
<html lang="en">
	...
	<head>
	    ...
	    <title>Fexpro Sage - FW22 Factory Order</title>
	    <!-- chartist CSS -->
	    ...
	    <div id="main-wrapper">
			...
			$(function () {
					...
					$( document ).ajaxComplete(function() {
						...
						$('#myTable tr .single-submit-it').bind('click', function () {
							...
							else
							{
								...
								form_data.append('action', 'alpha_adding_ss22_factory_data');
				...
				{	
					...
					form_data.append('action', 'alpha_export_pagination_based_ss22_place_order_data');
					jQuery.ajax({
						type: "POST",
						url: "https://shop2.fexpro.com/wp-admin/admin-ajax.php",
						contentType: false,
