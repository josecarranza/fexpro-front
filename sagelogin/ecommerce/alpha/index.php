...
$fw24_q3 = $wpdb->get_results( "SELECT ID FROM $wpdb->posts WHERE post_type = 'shop_order'
    AND post_status IN ('wc-fw24-q3')
");
/* END */
...
<body class="skin-default fixed-layout">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title text-center">FALL WINTER 24 Q3</h4>
                              <div class="text-center"> 
                                    <h1 class="font-light"><?php echo (!empty($fw24_q3)) ? count($fw24_q3) : 0 ?></h1>
                                </div>
                                <span class="text-info"><?php echo (!empty($fw24_q3)) ? (count($fw24_q3) / 100).'%' : '0%'; ?></span>
                                <div class="progress">
                                    <div class="progress-bar bg-info" role="progressbar" style="width: <?php echo (!empty($fw24_q3)) ? (count($fw24_q3) / 100).'%' : '0%'; ?>; height: 6px;" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100"></div>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row">
                    <?php 
                        foreach ($ventas_pais as $key => $value): ?>
                        
                        <div class="col-xl-2 col-lg-3 col-md-6">
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="card-title text-center"><?=$value->country_str?></h4>
                                    <div class="text-center"> 
                                        <h1 class="font-light" style="font-size:20px">$<?=number_format($value->country!="MX"?$value->total:$value->total_calc,2)?></h1>
                                        <?php if($value->country=="MX"):?>
                                        <span style="position: absolute;left: 0px;right: 0px;bottom: 5px;">($<?=number_format($value->total ,2)?>)</span>
                                        <?php endif;?>
                                    </div>
                    ...
                    <div class="col-lg-4 col-md-12">
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                <div class="card">
                                    <div class="card-body">
                                        <h5 class="card-title">ORDER STATS (Units)</h5>
                                        <div id="morris-donut-chart" class="ecomm-donute"></div>
                                        <textarea id="ecomm-donute-data" class="d-none">
                                            <?php 
                                            $json = array();
                                            foreach ($ventas_pais as $key => $value):
                                                $json[]=array("label"=>$value->country_str,"value"=>round($value->total_units,0));
                                            endforeach;
                                        ...
                                        <ul class="list-inline m-t-30">
                                            <?php 
                                             foreach ($ventas_pais as $key => $value): ?>
                                                <li class="list-inline-item p-r-20 mb-2" style="width:45%">
                                                    <h5 class="text-muted mb-0"><i class="fa fa-circle" style="color: <?=$coloresPastel[$key]?>"></i>
                                                        <?=$value->country_str?>
                                                    </h5>
                                                    <h4 class="m-b-0 totalOrderCount"><?=number_format($value->total_units,0)?></h4>
                                                </li>
                                            <?php endforeach; ?>
    ...
    <!--Custom JavaScript -->
    <script src="dist/js/ecom-dashboard.js?v=1"></script>
