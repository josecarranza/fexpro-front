...
<html lang="en">
	...
	<head>
	    ...
	    <?php /* Custom CSS for Table   */ ?>
			...
			.cart-sizes-attribute .size-guide .inner-size {	  border: solid 1px #000;    margin-top: 10px;  border-bottom: none;    border-right: none;     border-left: none;}
	...
	<body class="skin-default fixed-layout">
		...
		<script>
			...
			{	
				...
				form_data.append('action', 'export_pagination_based_ss22_order_data');
				jQuery.ajax({
					type: "POST",
					url: "https://shop.fexpro.com/wp-admin/admin-ajax.php",
					contentType: false,
