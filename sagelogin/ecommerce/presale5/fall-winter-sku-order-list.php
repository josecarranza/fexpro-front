...
$t = 'Fall Winter 22 --- SKU Order list';
$p = 'SKU Order list';
...
$orders = wc_get_orders( array(
    'limit'    => -1,
    'status' => array('wc-pending', 'wc-cancelled'),
	'return' => 'ids',
) );
	   ...
	   $variation_id = $item->get_variation_id();
		if(!empty($product_id) && !empty($variation_id))
	    {
			if( has_term( $_GET['fall-winter-22'] , 'product_cat' ,  $product_id) )
			{
				...
				$final_result1[$k . "removeText" . $order->get_status()][] = "<a href='https://shop.fexpro.com/wp-admin/post.php?post=$order_id&action=edit'>$order_id</a>";
