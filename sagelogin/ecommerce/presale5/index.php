...
$post_status = implode("','", array('wc-processing', 'wc-pending', 'wc-presale3') );
...
$SpringSummer22 = $wpdb->get_results( "SELECT ID FROM $wpdb->posts WHERE post_type = 'shop_order'
    AND post_status IN ('wc-presale3')
");
/* END */
...
$post_status_arr1 = $post_status_arr2 = $post_status_arr3 = [];
$totalFW21Orders = $totalPOPOrders = $totalFW21Orders = '';
        ...
        <header class="topbar">
            <nav class="navbar top-navbar navbar-expand-md navbar-dark">
                ...
                <div class="navbar-header">
                    <a class="navbar-brand" href="<?php echo SITEURL; ?>/sagelogin/ecommerce/presale5/">
                        <!-- Logo icon --><b>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title text-center">FEXPRO POP ORDERS</h4>
                                <div class="text-center"> 
                                    <h1 class="font-light"><?php echo (!empty($FexproPOPOrderCount)) ? count($FexproPOPOrderCount) : 0 ?></h1>
                                </div>
                                <span class="text-info"><?php echo (!empty($FexproPOPOrderCount)) ? (count($FexproPOPOrderCount) / 100).'%' : '0%'; ?></span>
                                <div class="progress">
                                    <div class="progress-bar bg-info" role="progressbar" style="width: <?php echo (!empty($FexproPOPOrderCount)) ? (count($FexproPOPOrderCount) / 100).'%' : '0%'; ?>; height: 6px;" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100"></div>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title text-center">SPRING SUMMER 22 ORDERS</h4>
							  <div class="text-center"> 
