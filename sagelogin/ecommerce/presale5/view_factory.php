...
$getZenlineOrdersList = $wpdb->get_results("SELECT * FROM {$wpdb->prefix}fw22_factory_order_confirmation_list WHERE `factoryname` = '$namee'  ", ARRAY_A );
...
<?php }else{
    header('location: http://shop.fexpro.com/sagelogin/ecommerce/pages-login.php');
    exit;
} ?>