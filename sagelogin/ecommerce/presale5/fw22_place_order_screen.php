	            ...
	            <div class="container-fluid">
	                ...
	                <div class="row page-titles">
	                    <div class="col-md-5 align-self-center">
	                        <h4 class="text-themecolor">View FW22 Place Orders</h4>
	                    </div>
	                    <div class="col-md-7 align-self-center text-right">
	                        <div class="d-flex justify-content-end align-items-center">
	                            <ol class="breadcrumb">
	                                <li class="breadcrumb-item"><a href="javascript:void(0)">Home</a></li>
	                                <li class="breadcrumb-item active">View FW22 Place Orders</li>
	                            </ol>
	                        </div>
	                    </div>
	                </div>
			  ...
			  jQuery(".fltrow th [ct='"+index+"']").parent().hide();
				...
				jQuery(".single-submit-it").on('click', function() {
					...
					else
					{
						...
						form_data.append('action', 'adding_fw22_factory_data');
