		...
		public function addCSPWrapperToPriceHtml( $priceHtml, $product) {
			if (wp_doing_ajax()) {
				if ($product->get_type()=='variable') {
					...
					/**
					 * Get CSP price for the product quantity.
					 * 
					 * @param float $price Current product price.
					 * @param int $productId Id of the woocommerce product.
					 * @param int $quantity quantity for which CSP price is required.
					 * @param int $userId user Id of the user for whom the CSP is required.
					 */
