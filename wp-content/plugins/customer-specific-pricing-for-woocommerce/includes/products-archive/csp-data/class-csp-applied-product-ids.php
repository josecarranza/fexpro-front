...
if (!class_exists('CSPAppliedProductIds')) {
	class  CSPAppliedProductIds {
		 ...
		 *
		 * @param int $userId
		 * @param array $roleSlugss
		 */
		public function __construct( $userId, $userRoleSlugs, $userGroupIds) {
			if (!empty($userId) && is_numeric($userId)) {
				$this->setUserId($userId);
				$this->setUserRoles($userRoleSlugs);
		 ...
		 * @return void
		 */
		private function setUserGroupIds( $groupIds) {
		 ...
		 * @return void
		 */
		private function setUserRoles( $userRoles) {
		...
		private function getProductIdsUSP() {
			$productIds 		= array();
			/**
			 * This filter can be used to disable/enable shoowing the products discounted with user specific pricing on the special shop page.
			 * 
			 * @param bool $show default True.
			 * @param int $userId Id of the user for whom special shop page is being prepared.
			 * @param array $roles user roles to which the user belong.
			 * @param array $userGroups user groups of the user.
			 * 
			 */
		...
		private function getProductIdsRSP() {
			$productIds			= array();
			/**
			 * This filter can be used to disable/enable shoowing the products discounted with role specific pricing on the special shop page.
			 * 
			 * @param bool $show default True.
			 * @param int $userId Id of the user for whom special shop page is being prepared.
			 * @param array $roles user roles to which the user belong.
		...
		private function getProductIdsGSP() {
			$productIds 		= array();
			/**
			 * This filter can be used to disable/enable shoowing the products discounted with group specific pricing on the special shop page.
			 * 
			 * @param bool $show default True.
			 * @param int $userId Id of the user for whom special shop page is being prepared.
			 * @param array $roles user roles to which the user belong.
		...
		private function getCatProductIdsUSP() {
			$productIds 		= array();
			/**
			 * This filter can be used to disable/enable shoowing the products discounted with user specific category pricing on the special shop page.
			 * 
			 * @param bool $show default True.
			 * @param int $userId Id of the user for whom special shop page is being prepared.
			 * @param array $roles user roles to which the user belong.
		...
		private function getCatProductIdsRSP() {
			$productIds 		= array();
			/**
			 * This filter can be used to disable/enable shoowing the products discounted with role specific category pricing on the special shop page.
			 * 
			 * @param bool $show default True.
			 * @param int $userId Id of the user for whom special shop page is being prepared.
			 * @param array $roles user roles to which the user belong.
		...
		private function getCatProductIdsGSP() {
			$productIds 		= array();
			/**
			 * This filter can be used to disable/enable shoowing the products discounted with group specific category pricing on the special shop page.
			 * 
			 * @param bool $show default True.
			 * @param int $userId Id of the user for whom special shop page is being prepared.
			 * @param array $roles user roles to which the user belong.
