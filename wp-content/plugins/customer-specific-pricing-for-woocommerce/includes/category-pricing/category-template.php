...
if (!class_exists('CategoryTemplate')) {
	class CategoryTemplate {
		...
		private function featureHeader() {
			...
			$checked		= 'enable'==$featureStatus?true:false;
			?>
			<div class="wrap csp-category-specific-pricing-tab">
				...
				<div class="row feature-switch-row ">
					<div class="feature-switch">
						<label class="switch" title="Enable/Disable Feature">
							<input type="checkbox" id="csp-cat-feature-switch" <?php checked($checked); ?> >
				...
				<div class="csp-notes-content">
					<ol>
							...
							<ol>
								...
								<li><?php esc_html_e('Global Disscounts', 'customer-specific-pricing-for-woocommerce'); ?></li>
					...
					<ul>
						<li>
							<a href="https://wisdmlabs.com/docs/article/wisdm-customer-specific-pricing/csp-getting-started/csp-user-guide/category-pricing/" target="_blank">
							<?php esc_html_e('Category Specific Pricing'); ?><span class="dashicons dashicons-external" style="font-size: 16px;"></span>
							</a>
						</li>
					</ul>
				</div>
