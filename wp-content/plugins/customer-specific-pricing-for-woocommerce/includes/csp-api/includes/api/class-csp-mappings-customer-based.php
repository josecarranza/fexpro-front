...
class CspMappingsCustomerBased extends CspMappings {
		...
		register_rest_route(
			...
			array(
				array(
					...
					'permission_callback' => array($this, 'isUserAllowedToDelete'),
				),
				array(
	...
	public function addCsp( $request) {
		...
		/**
		 * Filter the API response data for the newly created rules by API callback
		 * 
	...
	public function deleteCsp( $request) {
		...
		$response = $this->generateResponseData($response, $request);
		/**
		 * Filter the API response data for the deleted rules by API callback
		 * 
		 * @param object $response responce data generated by API callback.
		 * @param object $request API request data.
		 */
	...
	public function getCspForUser( $request, $customerId, $failedkey) {
		...
		/**
		 * Filter the API response data for the get all rules by user id query in API callback
		 * 
		 * @param object $response responce data generated by API callback.
		 * @param object $request API request data.
		 */
	...
	public function getCspForUserByEmail( $request) {
		...
		/**
		 * Filter the API response data for the get user rules by user emails query in API callback
		 * 
		 * @param object $response responce data generated by API callback.
		 * @param object $request API request data.
		 */
	...
	public function getCspForUserById( $request) {
		...
		/**
		 * Filter the API response data for the get user rules by user id query in API callback
		 * 
		 * @param object $response responce data generated by API callback.
		 * @param object $request API request data.
		 */
	...
	public function getCspForUserProductByEmail( $request) {
		...
		/**
		 * Filter the API response data for the get user rules for product by user email query in API callback
		 * 
		 * @param object $response responce data generated by API callback.
		 * @param object $request API request data.
		 */
	...
	public function getCspForUserProductById( $request) {
		...
		/**
		 * Filter the API response data for the get user rules on product by product id query in API callback
		 * 
		 * @param object $response responce data generated by API callback.
		 * @param object $request API request data.
		 */
	...
	public function getCspForUserProduct( $request, $customerId, $productId, $failedKey) {
		...
		$response = $this->generateResponseData($response, $request);
		/**
		 * Filter the API response data for the get user rules by product id query in API callback
		 * 
		 * @param object $response responce data generated by API callback.
		 * @param object $request API request data.
		 */
	...
	public function getCspForProduct( $request) {
		...
		$response = $this->generateResponseData($response, $request);
		/**
		 * Filter the API response data for the get all the rules by product id query in API callback
		 * 
		 * @param object $response responce data generated by API callback.
		 * @param object $request API request data.
		 */
	...
	public function formatCspDataForUserResponse( $cspData, $singleProductResponse = false) {
		...
		/**
		 * Filter the CSP API request response data
		 * 
		 * @param array $response array of responce objects for API requests
		 * @param array $cspData CSP data for a particular user/ product.
		 * @param  bool $singleProductResponse True if '$cspData' contains pricing
		 *                              		about a single product. False if '$cspData'
		 *                              		contains pricing for all products about a
	...
	public function formatCspDataForProductResponse( $cspData) {
		...
		/**
		 * Filter for Formatted API responce generated by CSP API,
		 * 
		 * @param array $response Array containing formatted CSP data for API response.
		 * @param array $cspData Array containing all pricing mappings of a
		 *                             specific product.
		 * 
		 */
	...
	public function isCustomerMappingExists( $productId, $userId, $minQty) {
		...
		/**
		 * Filter to changeg the result for whether customer mapping exists in 'wusp_user_pricing' table.
		 * 
		 * @param bool $result	whether customer mapping exists in 'wusp_user_pricing' table.
		 * @param int $userId	Id of the WP user specified in the API request
		 * @param int $productId Id of the WC product.
		 * @param int $minQty Minimum quantity field in the rule. 
		 */
