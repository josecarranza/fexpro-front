...
class GroupBasedCspMappings extends CspMappings {
	...
	public function deleteGsp( $request) {
		...
		$response = $this->generateResponseData($response, $request);
		/**
		 * Filter for API delete request response for group specific pricing rules, the same can be used to filter the API delete operation response
	...
	public function getGspForGroup( $request, $groupName, $failedkey) {
		...
		$response = $this->generateResponseData($response, $request);
		/**
		 * Filter for CSP API get request response for the group specific pricing.
		 * 
		 * @param array $response responce prepared by the API callback
		 * @param array $request CSP API request data
		 */
	...
	public function getGspForGroupByName( $request) {
		...
		/**
		 * Filter for CSP API get request response for the group specific pricing by group name.
		 * 
		 * @param array $response responce prepared by the API callback
		 * @param array $request CSP API request data
		 */
	...
	public function getGspForGroupByProductId( $request) {
		...
		/**
		 * Filter for CSP API get request response for the group specific pricing by product Id.
		 * 
		 * @param array $response responce prepared by the API callback
		 * @param array $request CSP API request data
		 */
	...
	public function getGspForGroupProduct( $request, $groupName, $productId, $failedKey) {
		...
		/**
		 * Filter for CSP API get request response for the group specific pricing by group name & product Id.
		 * 
		 * @param array $response responce prepared by the API callback
		 * @param array $request CSP API request data
		 */
	...
	public function isGroupMappingExists( $productId, $groupId, $minQty) {
		...
		/**
		 * Filter to changeg the result for whether group mapping exists in 'wusp_group_product_price_mapping' table.
		 * 
		 * @param bool $result	whether group mapping exists in 'wusp_group_product_price_mapping' table.
		 * @param int $groupId	Id of the WP user group.
