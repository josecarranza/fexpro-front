...
class RoleBasedCspMappings extends CspMappings {
	...
	public function addRsp( $request) {
		...
		/**
		 * Filter to filter out the Generated CSP API response.
		 * 
		 * @param array $response Response data generated by the API callback.
		 * @param array $request CSP API request data.
		 */
	...
	public function deleteRsp( $request) {
		...
		$response = $this->generateResponseData($response, $request);
		/**
		 * Filter for API delete request response for role specific pricing rules, the same can be used to filter the API delete operation response
		 * or to take certain actions post the delete request execution based on the results.
		 * 
		 * @param array $response responce prepared by the API callback
		 * @param array $request CSP API request data
		 */
	...
	public function getRspForrole( $request, $role, $failedkey) {
		...
		/**
		 * Filter for CSP API get request response for the role specific pricing.
		 * 
		 * @param array $response responce prepared by the API callback
		 * @param array $request CSP API request data
		 */
	...
	public function getRspForRoleByName( $request) {
		...
		/**
		 * Filter for CSP API get request response for the role specific pricing by role slug.
		 * 
		 * @param array $response responce prepared by the API callback
		 * @param array $request CSP API request data
		 */
	...
	public function getRspForRoleByProductId( $request) {
		...
		/**
		 * Filter for CSP API get request response for the role specific pricing by product Id.
		 * 
		 * @param array $response responce prepared by the API callback
		 * @param array $request CSP API request data
		 */
	...
	public function getRspForRoleProduct( $request, $role, $productId, $failedKey) {
		...
		/**
		 * Filter for CSP API get request response for the group specific pricing by role-slug & product Id.
		 * 
		 * @param array $response responce prepared by the API callback
		 * @param array $request CSP API request data
		 */
	...
	public function formatRspDataForProductResponse( $rspData) {
		 ...
		 * 
		 * @param array $response responce prepared by the API callback
		 * @param   array   $rspData    RSP data for a particular group/ product.
		 */
	...
	public function isRoleMappingExists( $productId, $role, $minQty) {
		...
		/**
		 * Filter to changeg the result for whether role mapping exists in 'wusp_role_pricing_mapping' table.
		 * 
		 * @param bool $result	whether group mapping exists in 'wusp_role_pricing_mapping' table.
		 * @param int $role	wp user-role slug.
