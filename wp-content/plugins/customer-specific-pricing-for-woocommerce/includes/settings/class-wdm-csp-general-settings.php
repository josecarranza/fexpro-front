		...
		*/
		...
		<div class="container">
				<form name="ask_product_form" id="ask_product_form" class="form-table" method="POST" action="options.php">
					...
					$cspParentCategoryDiscount		= isset($cspSettings['csp_enable_category_hierarchy']) && 'enable' == $cspSettings['csp_enable_category_hierarchy'] ? true : false;
					$useOldImportFaeature			= isset($cspSettings['csp_use_old_import']) && 'enable' == $cspSettings['csp_use_old_import'] ? true:false;
					...
					$cspParentCategoryDiscountHelp	=	__('Enabling this option will let the pricing for parent categories apply on all of its child categories', 'customer-specific-pricing-for-woocommerce');
					$useOldImportFaeatureHelp		=   __('Enabling will start showing old import feature settings on the import admin page ', 'customer-specific-pricing-for-woocommerce');
					...
					$this->settingUseOldImport($useOldImportFaeature, $useOldImportFaeatureHelp);
					...
					$this->cspCategoryPricingSetting($cspParentCategoryDiscount, $cspParentCategoryDiscountHelp);
		...
		/**
		 * Prints the setting to Enable CSP old import feature
		 *
		 * @param string $useOldImportFaeature
		 * @param string $useOldImportFaeatureHelp
		 * @return void
		 */
		public function settingUseOldImport( $useOldImportFaeature, $useOldImportFaeatureHelp) {
			?>
			<div class="fd">
				<div class='left_div col-md-3 form-control-label'>
					<label for="csp_use_old_import"><?php esc_html_e('Use Old Import Feature', 'customer-specific-pricing-for-woocommerce'); ?></label>
				</div>
				<div class='right_div col-md-6 form-control-label'>
					<input type="checkbox" class="wdm_csp_input wdm_wpi_checkbox" name="wdm_csp_settings[csp_use_old_import]" value="enable" <?php checked(1, $useOldImportFaeature); ?>
					 id="csp_use_old_import" />
					<br>
					<p class="help-text"><?php echo esc_html($useOldImportFaeatureHelp); ?></p>
				</div>
				<div class='clear'>
				</div>
			</div >
		...
		/**
		 * Prints the setting field to Enable/Disable the discount on the parent categories to be
		 * considered for its chield categories.
		 *
		 * @since 4.5.0
		 * @param string $cspParentCategoryDiscount - Status of the feature
		 * @param string $cspParentCategoryDiscountHelp - Help Text
		 * @return void
		 */
		public function cspCategoryPricingSetting( $cspParentCategoryDiscount, $cspParentCategoryDiscountHelp) {
			?>
			<div class="csp-setting-section-seperator">
			<hr>
			<h4><?php esc_html_e('Category Pricing Settings', 'customer-specific-pricing-for-woocommerce'); ?></h4>
			</div>
			<div class="fd">
				<div class='left_div col-md-3 form-control-label'>
					<label for="csp_enable_category_hierarchy"><?php esc_html_e('Discounts On Parent Categories', 'customer-specific-pricing-for-woocommerce'); ?></label>
				</div>
				<div class='right_div col-md-6 form-control-label'>
					<input type="checkbox" class="wdm_csp_input wdm_wpi_checkbox" name="wdm_csp_settings[csp_enable_category_hierarchy]" value="enable" <?php checked(1, $cspParentCategoryDiscount); ?>
					 id="csp_enable_category_hierarchy" />
					<br>
					<p class="help-text"><?php echo esc_html($cspParentCategoryDiscountHelp); ?></p>
				</div>
				<div class='clear'>
				</div>
			</div >
