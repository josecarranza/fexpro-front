	...
	class WdmCSPCartDiscount {
		...
		*/
		...
		public function cartDiscountTabCallBack() {
			?>
			<div class="wrap csp-cart-discounts-tab"><h3 class="csp-tab-header">
		...
		public function getCartDiscountPageHtml() {
			...
			<div class="row csp-cd-main-div-notes" style="display: block;">
				...
				<div class="cd-notes-content">
					...
					<ol>
					<ul>
						<a href="https://wisdmlabs.com/docs/article/wisdm-customer-specific-pricing/csp-getting-started/csp-user-guide/cart-discounts-2/" target="_blank">
						<?php esc_html_e('Cart Discounts Documentation'); ?><span class="dashicons dashicons-external" style="font-size: 16px;"></span>
						</a>
					</ul>
					</ol>
				</div>
