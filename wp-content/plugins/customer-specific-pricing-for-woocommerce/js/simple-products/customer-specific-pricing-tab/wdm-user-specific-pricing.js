jQuery('document').ready(function () {
    ...
    var i = jQuery('#wdm_user_specific_pricing_tbody tr').length + 1;
    ...
    jQuery('body').on('focus', '#wdm_user_specific_pricing_tbody .wdm_price:last', function() {
        jQuery( this ).closest('tbody').find( '#wdm_add_new_user_price_pair' ).click();
    });
