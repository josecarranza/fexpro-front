<?php
	...
	if( !class_exists('Wbcr_FactoryMetaboxes409_FormMetabox') ) {
		...
		abstract class Wbcr_FactoryMetaboxes409_FormMetabox extends Wbcr_FactoryMetaboxes409_Metabox {
			...
			/**
			 * @var Wbcr_FactoryForms450_MetaValueProvider
			 */
			protected $provider;
			...
			/**
			 * @param null $post_id
			 * @return Wbcr_FactoryForms450_Form
			 */
			private function getForm($post_id = null)
			{
				// creating a value provider
				$this->provider = new Wbcr_FactoryForms450_MetaValueProvider(array(
					'scope' => $this->scope
				));
				...
				// creating a form
				$form = new Wbcr_FactoryForms450_Form(array(
					'scope' => $this->scope,
					'name' => $this->id
				), $this->plugin);
			...
			public function html()
			{
				...
				echo '<div class="factory-form-metabox factory-bootstrap-454">';
			 ...
			 */
			public function beforeForm(Wbcr_FactoryForms450_Form $form)
			{
				return;
			}
			 ...
			 */
			public function afterForm(Wbcr_FactoryForms450_Form $form)
			{
				return;
			}
