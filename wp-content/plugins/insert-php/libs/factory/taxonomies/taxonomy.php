<?php
	...
	//add_action('factory_453_plugin_activation', 'FactoryTaxonomy000::activationHook');
	//add_action('factory_453_plugin_deactivation', 'FactoryTaxonomy000::deactivationHook');
