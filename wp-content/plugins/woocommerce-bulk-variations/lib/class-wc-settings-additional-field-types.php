...
if ( ! class_exists( 'WC_Settings_Additional_Field_Types' ) ) {
     ...
     * @version   1.4
     * @deprecated Replaced by Barn2\WBV_Lib\WooCommerce\Admin\Custom_Settings_Fields;
     */
            ...
            <tr valign="top">
                ...
                <td class="forminp forminp-<?php echo sanitize_title( $value['type'] ) ?> color-size-field">&lrm;
                    ...
                    <input
                        ...
                        placeholder="<?php _e( 'Color', 'woocommerce-bulk-variations' ); ?>"
                        />&lrm;
                    ...
                    <input
                        ...
                        placeholder="<?php _e( 'Size', 'woocommerce-bulk-variations' ); ?>"
