  ...
  Menu Saved
	...
	<div class="row mb-5">
		...
		<div class="col-12 mt-3">
			<button class="btn btn-primary" ng-click="guardar()" ng-disabled="disable_save">Save menú</button>
		</div>
	</div>
...
<script>
	...
	.controller("ctrl",($scope,$http,$timeout)=>{
		...
		$scope.removeItem=(level,index)=>{
			...
			///console.log(level,index);
			if(level==0){
				$scope.remove.push($scope.menu[index].id_menu_item);
			...
			if(level==1){
				$scope.remove.push($scope.menu_lvl1[index].id_menu_item);
			...
			if(level==2){
				$scope.remove.push($scope.menu_lvl2[index].id_menu_item);
			...
			if(level==3){
				$scope.remove.push($scope.menu_lvl3[index].id_menu_item);
		...
		template:`<div class="wfmenu-item {{open && 'open'}} {{$ctrl.item.selected ? 'selected':''}}">
			<div class="wfmenu-item-header" ng-click="$ctrl.ngClick" ng-dblclick="openCard()">
			...
			<div class="wfmenu-item-body">
				...
				<div class="form-group">
					<input type="checkbox" ng-click="$ctrl.item.disabled=!$ctrl.item.disabled" ng-model="$ctrl.item.disabled" /> Disable item
				</div>
