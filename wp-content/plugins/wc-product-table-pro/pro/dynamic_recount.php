...
function wcpt__dynamic_filter__init($attributes){
  $table_data = wcpt_get_table_data();
    ...
    remove_filter('wcpt_query_args', 'wcpt__dynamic_filter__cache_results', 1000, 1);    
  ...
  add_filter('wcpt_query_args', 'wcpt__dynamic_filter__cache_results', 1000, 1);
...
function wcpt__dynamic_filter__add_count( &$options, $results, $type= 'both', $table_id, $sc_attrs, $query_args ){
