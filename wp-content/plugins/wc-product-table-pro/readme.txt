...
## Shortcode options
Use shortcode options like category="shoes, pants" or ids="123, 124" or skus="woo-shirt, woo-pants" to re-use the shortcode to print different results each time. All shortcode options are listed next to the Shortcode in the table editor page. 
...
* NEW: Lifetime license also available at $129 only!
