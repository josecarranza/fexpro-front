jQuery( document ).ready(function( $ ) {
	...
	function wcbvp_calculate_product_totals() {
		...
		jQuery( ".wcbvp_quantity" ).each(function( i ) {
			...
			if ( quantity >= 0 ) {
				...
				var product_price = allqty * price
				var old_qty   = 0;
				var old_price = 0;
				...
				total_quantity[ table_id ]   = old_qty + allqty;
	...
	jQuery('#product-row-single-attribute > td input').on('input click keydown keyup', function() {
		...
		jQuery("#product-row-variation-images > td:nth-child("+ nextChild +") .size-guide .xyz > .inner-size > span:nth-child(2)").each(function() {
