...
foreach($allProducts as $value)
{
	...
	{
	   echo "FEXpro Style Images XML is created please click <a href='". site_url() ."/wp-content/themes/porto-child/style_imgs/IMG_" . $ak . ".xml' target='_blank'>Click Here " . $ak ."</a> <br><hr>"; 
	}
	else
	{
