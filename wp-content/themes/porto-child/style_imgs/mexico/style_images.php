...
foreach($allProducts as $value)
{
	...
	else
	{
		...
		$result->setAttribute('Producto', $ak1);
	...
	$root->appendChild($result);
	if($dom->save('IMG_' . $ak . '_mex.xml'))
	{
	   echo "FEXpro Mexico Style Images XML is created please click <a href='". site_url() ."/wp-content/themes/porto-child/mexico/style_imgs/IMG_" . $ak . ".xml' target='_blank'>Click Here " . $ak ."</a> <br><hr>"; 
	}
	else
	{
