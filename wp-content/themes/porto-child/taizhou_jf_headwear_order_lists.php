...
$getZenlineOrdersList = $wpdb->get_results("SELECT * FROM {$wpdb->prefix}factory_order_confirmation_list WHERE `factoryname` = 'TAIZHOU J&F HEADWEAR'", ARRAY_A );
