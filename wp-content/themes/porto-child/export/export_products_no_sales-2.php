...
foreach ($allProducts as $key => $value) {
	...
	if ($dom->save('ss23_products_no_sales_xml/INV_all_fexpro_ss23_products_no_sales_'.($i_file+1).'.xml')) {
		echo "Fexpro SS23 Product XML is created please click <a href='" . site_url() . "/wp-content/themes/porto-child/export/ss23_products_no_sales_xml/INV_all_fexpro_ss23_products_no_sales_".($i_file+1).".xml' target='_blank'>Click Here All products part ".($i_file+1)." </a> <br><hr>";
	} else {
