...
foreach ($allProducts as $key => $value) {
	...
	if ($dom->save('fw23_products_mex_xml/INV_all_fexpro_fw23_products_mex_'.($i_file+1).'.xml')) {
		echo "Fexpro FW23 Product XML is created please click <a href='" . site_url() . "/wp-content/themes/porto-child/export/fw23_products_mex_xml/INV_all_fexpro_fw23_products_mex_".($i_file+1).".xml' target='_blank'>Click Here All products part ".($i_file+1)." </a> <br><hr>";
	} else {
