...
//}
	...
	if ($dom->save('core_products/INV_core_products_'.($i_file+1).'.xml')) {
    	echo "Fexpro Core Product XML is created please click <a href='" . site_url() . "/wp-content/themes/porto-child/export/core_products/INV_core_products_".($i_file+1).".xml' target='_blank'>Click Here All products part ".($i_file+1)." </a> <br><hr>";
	} else {
