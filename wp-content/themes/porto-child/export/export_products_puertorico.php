...
if ($dom->save('fw24_products_pr/INV_all_fexpro_fw24_products.xml')) {
    echo "Fexpro SS24 Product XML is created please click <a href='" . site_url() . "/wp-content/themes/porto-child/export/fw24_products_pr/INV_all_fexpro_fw24_products.xml' target='_blank'>Click Here All products</a> <br><hr>";
} else {
