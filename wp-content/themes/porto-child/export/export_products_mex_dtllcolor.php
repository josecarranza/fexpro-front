...
WHERE p.order_id IN (
	...
	WHERE pp.post_type='shop_order' AND pp.post_status='wc-fall winter 24-q3' AND pp.ID >=126125
 )
...
$multipleSizeArray = array("SIZES" => array("S-M-L-XL" => "25", "4-6-8-10-12-14-16" => "3", "7-8-9-10-11" => "SD", "28-29-30-31-32-33" => "CL", "OS" => "OS", "8-10-12-14-16" => "YH", "XS-S-M-L" => "WO", "10-11-12-13-1" => "C2", "40-41-43-44-45" => "E1",  "4-6-8-10" => "62","10-12-14-16" => "TE"));
...
foreach ($allProducts as $key => $value) {
	...
	if ($dom->save('ss24_products_mex_xml/INV_all_fexpro_ss24_products_mex'.($i_file+1).'.xml')) {
    	echo "Fexpro SS24 Product XML is created please click <a href='" . site_url() . "/wp-content/themes/porto-child/export/ss24_products_mex_xml/INV_all_fexpro_ss24_products_mex".($i_file+1).".xml' target='_blank'>Click Here All products part ".($i_file+1)." </a> <br><hr>";
	} else {
