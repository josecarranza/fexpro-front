...
foreach($r1 as $r1value)
{
	...
	if($dom->save('CNF_' . $newName . '_PAN.xml'))
	{
	   echo "FEXpro Factory XML is created please click <a href='". site_url() ."/wp-content/themes/porto-child/factory_order/CNF_" . $newName . "_PAN.xml' target='_blank'>Click Here " . $newName ."</a> <br><hr>"; 
	} 
	else
	{
