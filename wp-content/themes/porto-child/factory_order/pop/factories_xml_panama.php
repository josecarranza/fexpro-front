...
foreach($r1 as $r1value)
{
	...
	if($dom->save('CNF_' . $newName . '_pop_PAN.xml'))
	{
	   echo "Fexpro POP Factory XML is created please click <a href='". site_url() ."/wp-content/themes/porto-child/factory_order/pop/CNF_" . $newName . "_pop_PAN.xml' target='_blank'>Click Here " . $newName ."</a> <br><hr>"; 
	} 
	else
	{
