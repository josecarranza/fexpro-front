...
if($dom->save('INV_revised_all_products_with_price_fw21.xml'))
{
	echo "FEXpro Product XML is created please click <a href='https://shop.fexpro.com/wp-content/themes/porto-child/revised_fw21_pop_products_price/fw21/INV_revised_all_products_with_price_fw21.xml' target='_blank'>Click Here All products </a> <br><hr>"; 
}
else
{
