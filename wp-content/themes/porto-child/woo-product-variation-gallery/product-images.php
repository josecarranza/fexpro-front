...
<div style="<?php echo esc_attr(Functions::generate_inline_style($inline_style)) ?>"
    ...
    <div class="loading-rtwpvg rtwpvg-wrapper rtwpvg-thumbnail-position-bottom">
            ...
            <div class="rtwpvg-slider-wrapper">
                ...
                <div class="rtwpvg-slider"
                    ...
                    if ($has_post_thumbnail) :
                        ...
                        echo sprintf('<img src="%s" alt="%s" class="wp-post-image" />', esc_url('https://psychobunnylatam.com/wp-content/uploads/2020/12/wc_custom_placeholder.png'), esc_html__('Awaiting product image', 'woocommerce'));
                        echo '</div>';
                    endif;
