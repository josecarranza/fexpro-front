...
foreach($orders as $order_id)
{
	...
	else
	{
		...
		/* foreach($getMarca as $ak)
		{
			...
			if($dom->save('PED_' . $order_id . '_FW22.xml'))
			{
			   echo "SS22 Panama Order XML is created please click <a href='". site_url() ."/wp-content/themes/porto-child/fw22_order_xml/PED_" . $order_id . "_FW22.xml' target='_blank'>Click Here " . $order_id . " </a> <br>"; 
			}
			else
			{
