...
foreach($orders as $order_id)
{
	...
	if($order->get_billing_country() == 'MX')
	{
		...
		/* foreach($getMarca as $ak)
		{
			...
			if($dom->save('PED_' . $order_id . '_fw22_MEX.xml'))
			{
			   echo "SS22 Panama Order XML is created please click <a href='". site_url() ."/wp-content/themes/porto-child/fw22_order_xml/mexico/PED_" . $order_id . "_fw22_MEX.xml' target='_blank'>Click Here " . $order_id . " </a> <br>"; 
			}
			else
			{
