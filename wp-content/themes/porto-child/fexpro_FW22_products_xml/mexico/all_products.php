...
if($dom->save('INV_all_fexpro_fw22_products_mex.xml'))
{
   echo "FEXpro FW22 Product XML is created please click <a href='". site_url() ."/wp-content/themes/porto-child/fexpro_FW22_products_xml/mexico/INV_all_fexpro_fw22_products_mex.xml' target='_blank'>Click Here All products </a> <br><hr>"; 
}
else
{
