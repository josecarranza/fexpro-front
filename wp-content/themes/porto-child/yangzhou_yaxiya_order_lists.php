...
$getZenlineOrdersList = $wpdb->get_results("SELECT * FROM {$wpdb->prefix}factory_order_confirmation_list WHERE `factoryname` = 'YANGZHOU YAXIYA HEADWEAR & GAR'", ARRAY_A );
...
<h2>YANGZHOU YAXIYA HEADWEAR & GAR</h2>
