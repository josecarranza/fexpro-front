...
$getZenlineOrdersList = $wpdb->get_results("SELECT * FROM {$wpdb->prefix}factory_order_confirmation_list WHERE `factoryname` = 'QuanZhou TangRen Garments'", ARRAY_A );
...
<h2>QuanZhou TangRen Garments</h2>
