...
foreach($orders as $order_id)
{
	...
	if($dom->save('PED_' . $order_id . '_MEX.xml'))
	{
	   echo "FEXpro Order XML is created please click <a href='". site_url() ."/wp-content/themes/porto-child/orders_fexpro/mexico_presale_1_orders/PED_" . $order_id . "_MEX.xml' target='_blank'>Click Here " . $order_id . " </a> <br>"; 
	}
	else
	{
