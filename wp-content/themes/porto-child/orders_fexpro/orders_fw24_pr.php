...
foreach($orders as $order_id)
{
	...
	if($order->get_billing_country() == 'PR')
	{
		...
		$result->setAttribute('Otra_Cia', "12");
		...
		/* foreach($getMarca as $ak)
		{
			...
			if($dom->save('wc-fw24-q3-pr/PED_' . $order_id . '_243_pr.xml'))
			{
			   echo "Presale6 Mexico Order XML is created please click <a href='". site_url() ."/wp-content/themes/porto-child/orders_fexpro/wc-fw24-q3-pr/PED_" . $order_id . "_243_pr.xml' target='_blank'>Click Here " . $order_id . " </a> <br>"; 
			}
			else
			{
