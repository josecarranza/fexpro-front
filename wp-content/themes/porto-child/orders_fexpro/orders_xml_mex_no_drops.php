...
foreach($orders as $order_id)
{
	...
	if($order->get_billing_country() == 'MX')
	{
		...
		/* foreach($getMarca as $ak)
		{
			...
			if($dom->save('presale6_mex_no_drops/PED_' . $order_id . '_pre6_mex.xml'))
			{
			   echo "Presale6 Mexico Order XML is created please click <a href='". site_url() ."/wp-content/themes/porto-child/orders_fexpro/presale6_mex_no_drops/PED_" . $order_id . "_pre6_mex.xml' target='_blank'>Click Here " . $order_id . " </a> <br>"; 
			}
			else
			{
