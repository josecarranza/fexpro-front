...
foreach($orders as $order_id)
{
	...
	else
	{
		...
		/* foreach($getMarca as $ak)
		{
			...
			if($dom->save('PED_' . $order_id . '_pre5.xml'))
			{
			   echo "Presale5 Panama Order XML is created please click <a href='". site_url() ."/wp-content/themes/porto-child/orders_fexpro/presale5/PED_" . $order_id . "_pre4.xml' target='_blank'>Click Here " . $order_id . " </a> <br>"; 
			}
			else
			{
