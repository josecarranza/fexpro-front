...
foreach($orders as $order_id)
{
	...
	if($dom->save('PED_' . $order_id . '_pop_MEX.xml'))
	{
	   echo "Fexpro POP Mexico Order XML is created please click <a href='". site_url() ."/wp-content/themes/porto-child/orders_fexpro/processing/mexico/PED_" . $order_id . "_pop_MEX.xml' target='_blank'>Click Here " . $order_id . " </a> <br>"; 
	}
	else
	{
