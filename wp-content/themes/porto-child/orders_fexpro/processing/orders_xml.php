...
foreach($orders as $order_id)
{
	...
	else
	{
		...
		if($dom->save('PED_' . $order_id . '_pop.xml'))
		{
		   echo "Fexpro POP Panama Order XML is created please click <a href='". site_url() ."/wp-content/themes/porto-child/orders_fexpro/processing/PED_" . $order_id . "_pop.xml' target='_blank'>Click Here " . $order_id . " </a> <br>"; 
		}
		else
		{
