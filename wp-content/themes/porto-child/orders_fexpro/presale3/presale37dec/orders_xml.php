...
foreach($orders as $order_id)
{
	...
	else
	{
		...
		/* foreach($getMarca as $ak)
		{
			...
			{
			   echo "SS22 Panama Order XML is created please click <a href='". site_url() ."/wp-content/themes/porto-child/orders_fexpro/presale3/PED_" . $order_id . "_pop.xml' target='_blank'>Click Here " . $order_id . " </a> <br>"; 
			}
			else
			{
