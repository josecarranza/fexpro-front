...
foreach($orders as $order_id)
{
	...
	else
	{
		...
		/* foreach($getMarca as $ak)
		{
			...
			if($dom->save('presale6/PED_' . $order_id . '_pre6.xml'))
			{
			   echo "Presale6 Panama Order XML is created please click <a href='". site_url() ."/wp-content/themes/porto-child/orders_fexpro/presale6/PED_" . $order_id . "_pre6.xml' target='_blank'>Click Here " . $order_id . " </a> <br>"; 
			}
			else
			{
