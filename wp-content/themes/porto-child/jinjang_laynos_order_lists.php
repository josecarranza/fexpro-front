...
$getZenlineOrdersList = $wpdb->get_results("SELECT * FROM {$wpdb->prefix}factory_order_confirmation_list WHERE `factoryname` = 'JINJIANG LAYNOS SPORTS GARMENT'", ARRAY_A );
...
<h2>JINJIANG LAYNOS SPORTS GARMENT</h2>
