...
$getZenlineOrdersList = $wpdb->get_results("SELECT * FROM {$wpdb->prefix}factory_order_confirmation_list WHERE `factoryname` = 'QUANZHOU BEMY SPORTS CO.,LTD'", ARRAY_A );
...
<h2>QUANZHOU BEMY SPORTS CO.,LTD</h2>
