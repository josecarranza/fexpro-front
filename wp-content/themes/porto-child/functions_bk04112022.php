...
function add_order_again_status($array){
    ...
    $array = array_merge($array, array('on-hold','presale3','presale4', 'processing', 'pending-payment', 'cancelled', 'refunded', 'presale5'));
...
function bbloomer_add_edit_order_my_account_orders_actions( $actions, $order ) {
    ...
    if ( $order->has_status( 'pending' ) || $order->has_status( 'processing' )  || $order->has_status( 'presale3' ) || $order->has_status( 'presale4' )|| $order->has_status( 'presale5' )   ) {
...
add_filter( 'wc_order_is_editable', 'wc_make_processing_orders_editable', 10, 2 );
 ...
 function wc_make_processing_orders_editable( $is_editable, $order ) {
    ...
    if ( $order->get_status() == 'pending' || $order->get_status() == 'processing' || $order->get_status() == 'presale3'  || $order->get_status() == 'presale4'  || $order->get_status() == 'presale5') {
