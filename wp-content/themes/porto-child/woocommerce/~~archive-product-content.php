...
.brandColumns li {
	...
	span.brandTitle{display: flex;    font-size: 25px;
    font-weight: 800;
...
<?php if ( ( function_exists( 'woocommerce_product_loop' ) && woocommerce_product_loop() ) || ( ! function_exists( 'woocommerce_product_loop' ) && have_posts() ) ) { ?>
	...
	<div class="archive-products" id="ArchivePageStyleCustom">
		<?php
...
jQuery(function() {
  	   var sortable = jQuery("#ArchivePageStyleCustom ul");
				    var groups = [];
