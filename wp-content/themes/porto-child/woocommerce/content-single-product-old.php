...
if(isset($_GET["newlayout"])){
	include("content-single-product-wi.php");
	return;
}
...
$nFl = get_the_terms( $product->get_id() , 'pa_brand');
if($user_roles[0] == 'custom_role_mexico1' && $nFl[0]->slug == 'nfl')
{
	wp_redirect( '/', 301 ); 
	exit;
} */	
...
<div id="product-<?php the_ID(); ?>"  class="<?php echo esc_attr( $post_class ), ! $skeleton_lazyload ? '' : ' skeleton-loading'; ?>" data-custom_cat="<?php echo $akp; ?>">
<?php
