...
if (isset($_GET["f_warehouse"]) && $_GET["f_warehouse"]!="") {
    $filtros["f_warehouse"] = preg_replace("/[^a-zA-Z0-9\-,_\+]+/", "",$_GET["f_warehouse"]);
}
        ...
        <div class="row">
            <div class="col-6 col-md-4 col-lg-4 col-xl-3" ng-repeat="item in productos">
                ...
                <div class="card-img {{item.show_custom_image=='1' ? 'card-image-slider' : ''}}">
	                	<a href="{{item.link}}?f_delivery={{filtros.meta_delivery_date}}&wh={{filtros.f_warehouse}}">
                    ...
                    <a href="{{item.link}}?f_delivery={{filtros.meta_delivery_date}}&wh={{filtros.f_warehouse}}"><h5>{{item.titulo2 ? item.titulo2:item.titulo}}</h5></a>
            ...
            $scope.get_products = function() {
                    ...
                    $http({
                        ...
                        for(i in response.data.products){
                            ...
                            //response.data.products[i].colors = response.data.products[i].colors.filter((x,i)=>i<10);
