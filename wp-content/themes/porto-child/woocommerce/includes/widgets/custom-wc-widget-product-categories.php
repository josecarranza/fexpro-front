 ...
 * @extends WC_Widget
 */
class Custom_Widget_Product_Categories extends WC_Widget {
	...
	public function widget( $args, $instance ) {
		...
		if ( $dropdown ) {
			...
			include_once __DIR__ . '/../walkers/class-wc-product-cat-list-walker.php';


			$list_args['walker']                     = new WC_Product_Cat_List_Custom_Walker();
			$list_args['title_li']                   = '';
