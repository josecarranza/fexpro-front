...
if($dom->save('IMG_' . $ak . '.xml'))
	{
	   echo "FEXpro pop Style Images XML is created please click <a href='". site_url() ."/wp-content/themes/porto-child/ss22_images/bulk/IMG_" . $ak . ".xml' target='_blank'>Click Here " . $ak ."</a> <br><hr>"; 
	}
	else
	{
