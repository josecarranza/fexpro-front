<?php
// Configuración de errores para mostrar todos los errores
ini_set('display_errors', 1);
ini_set('display_startup_errors', 1);
error_reporting(E_ALL);

// Incluye el archivo principal de WordPress
include('../../../../wp-load.php');
global $wpdb;

// Define el período de fecha 'q2'
$qdate = "q3";

// Consulta SQL para obtener las variaciones vendidas en un período específico
...
// Configuración de los argumentos para obtener productos basados en las variaciones vendidas
$args = array(
