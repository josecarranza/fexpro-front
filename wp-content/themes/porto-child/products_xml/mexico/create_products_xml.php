...
foreach($allProducts as $key => $value)
{
	...
	else
	{
		...
		if($dom->save('INV_' . $value->ID . '_MEX.xml'))
		{
		   echo "FEXpro Mexico Product XML is created please click <a href='". site_url() ."/wp-content/themes/porto-child/products_xml/mexico/INV_" . $value->ID . "_MEX.xml' target='_blank'>Click Here " . $value->ID ."</a> <br><hr>"; 
		}
		else
		{
