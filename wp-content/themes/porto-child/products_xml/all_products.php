...
if($dom->save('INV_all_products.xml'))
	{
	   echo "FEXpro Product XML is created please click <a href='". site_url() ."/wp-content/themes/porto-child/products_xml/INV_all_products.xml' target='_blank'>Click Here All products </a> <br><hr>"; 
	}
	else
	{
		die('XML Create Error');
