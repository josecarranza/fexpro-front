...
if($dom->save('INV_all_fexpro_pop_products.xml'))
{
   echo "FEXpro Pop Product XML is created please click <a href='". site_url() ."/wp-content/themes/porto-child/fexpro_pop_products_xml/INV_all_fexpro_pop_products.xml' target='_blank'>Click Here All products </a> <br><hr>"; 
}
else
{
