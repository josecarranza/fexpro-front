...
$getZenlineOrdersList = $wpdb->get_results("SELECT * FROM {$wpdb->prefix}factory_order_confirmation_list WHERE `factoryname` = 'QUANZHOU JUNTOUR GARMENTS'", ARRAY_A );
...
<h2>QUANZHOU JUNTOUR GARMENTS</h2>
