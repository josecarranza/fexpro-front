...
foreach($allProducts as $key => $value)
{
	...
	foreach($cat as $cvalue)
	{
		if($cvalue->parent != 0)
		{
			...
			if($cvalue->slug == 'youth' || $cvalue->slug == 'caps-youth')
			{
	...
	else
	{
		...
		{
		   echo "FEXpro Pop Product XML is created please click <a href='". site_url() ."/wp-content/themes/porto-child/fexpro_pop_products_xml/INV_" . $value->ID . ".xml' target='_blank'>Click Here " . $value->ID ."</a> <br><hr>"; 
		}
		else
		{
