...
//if ( class_exists('Woocommerce') && ( is_cart() || is_checkout() ) && $woo_breadcrumb ) :
 if ( class_exists('Woocommerce') && ( is_cart() || is_checkout() ) && $woo_breadcrumb ) :	
	?>
	<div class="woo-page-header page-header-8 d-none">
	...
	<div class="container page-top">
		<div class="row">
			<div class="col-lg-12">
				<div class="breadcrumbs-wrap checkout-breadcrumb">
					<ul class="breadcrumb" itemscope=""  >
						<li class="home" itemprop="itemListElement" itemscope="" itemtype="http://schema.org/ListItem">
						<a  itemprop="item" href="<?=get_site_url()?>" title="Go to Home Page"><span itemprop="name">Home</span><meta itemprop="position" content="1"></a>
