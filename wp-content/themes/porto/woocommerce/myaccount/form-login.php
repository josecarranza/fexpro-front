...
<div class="<?php echo ( true == $lightbox ? '' : ( 'no' === get_option( 'woocommerce_enable_myaccount_registration' ) ? esc_html( 'col-md-6 mx-auto mb-4' ) : esc_html( 'col-lg-10 mx-auto mb-4' ) ) ); ?>">
	...
	<div class="align-left <?php echo ( true == $lightbox ? esc_html( 'featured-box' ) : '' ); ?>">
		<div class="box-content login-box">
			...
			<?php endif; ?>
			<style>
				body.login-popup .fixed-header {
    display: none;
}

body.login-popup section.page-header-1 {
    display: none;
}
#main{
	border-top:40px solid #BC363F;
	padding-top:60px !important;
}

			</style>
			<div class="text-center login-logo">
				<img src="<?=get_site_url()?>/wp-content/uploads/2021/11/LOGO-FEXPRO-2-1.png" height="60px" alt="">
			</div>
					<form class="woocommerce-form woocommerce-form-login login <?php echo false === $lightbox && 'yes' === get_option( 'woocommerce_enable_myaccount_registration' ) ? 'pr-lg-4 pr-0' : ''; ?>" method="post">
						...
						<p class="woocommerce-form-row woocommerce-form-row--wide form-row form-row-wide">
							<label class="mb-1 font-weight-medium" for="username"><?php esc_html_e( 'Username or email', 'woocommerce' ); ?>&nbsp; </label>
						...
						<p class="woocommerce-form-row woocommerce-form-row--wide form-row form-row-wide mb-2">
							<label class="mb-1 font-weight-medium" for="password"><?php esc_html_e( 'Password', 'woocommerce' ); ?>&nbsp; </label>
						...
						<div class="woocommerce-LostPassword lost_password  mb-4">
							<div>
						...
						<p class="form-row mb-3 mb-lg-0 pb-1 pb-lg-0 text-center">
							<?php wp_nonce_field( 'woocommerce-login', 'woocommerce-login-nonce' ); ?>
							<button type="submit" class="woocommerce-Button button login-btn btn-v-dark py-3 text-md w-100" name="login" value="<?php esc_attr_e( 'Log in', 'woocommerce' ); ?>"><?php esc_html_e( 'Log in', 'woocommerce' ); ?></button>
						</p>
