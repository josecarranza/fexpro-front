...
foreach ($allProducts as $key => $value) {
	...
	if ($dom->save('ss24_products_xml/INV_all_fexpro_ss24_products_'.($i_file+1).'.xml')) {
    echo "Fexpro SS24 Product XML is created please click <a href='" . site_url() . "/wp-content/themes/porto-child/export/ss24_products_xml/INV_all_fexpro_ss24_products_".($i_file+1).".xml' target='_blank'>Click Here All products part ".($i_file+1)." </a> <br><hr>";
} else {
