...
$getZenlineOrdersList = $wpdb->get_results("SELECT * FROM alpha_wp_ss22_presale4_factory_order_confirmation_list WHERE `factoryname` = '$names'   ", ARRAY_A );
    ...
    jQuery.ajax({
        ...
        error: function(errorThrown){
            ...
            {   
                ...
                form_data.append('action', 'export_cart_presale4_entries_all_data');
                jQuery.ajax({
                    type: "POST",
                    url: "https://shop.fexpro.com/wp-admin/admin-ajax.php",
                    contentType: false,
